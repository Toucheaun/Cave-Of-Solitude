...
#define T  TILE_SPAWNER_T
	...
	case 2:
		...
		TileType v[21][21] =
		{
		{W,H,H,H,W,H,W,H,H,H,F,H,H,H,H,H,H,H,H,H,W},
		{W,F,F,F,F,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,W,H,H,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,W,F,F,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,W,F,W,H,H,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,W,F,H,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,W,F,F,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,H,H,W,H,H,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,F,F,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,H,W,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{F,F,H,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F},
		{W,F,F,F,W,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
		{W,H,H,H,H,F,F,F,F,F,F,F,F,F,F,F,F,F,F,F,W},
